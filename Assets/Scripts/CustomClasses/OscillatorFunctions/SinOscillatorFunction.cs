...
{
    /// <summary>
    ///     Returns oscillations of function: sin(x)
    /// </summary>
    public sealed class SinOscillatorFunction : OscillatorFunction
    {
        /// <summary>
        ///     Returns oscillations of function: sin(x)
        /// </summary>
        ...
        public SinOscillatorFunction(float oscillatorAngle0, float frequency) : base(oscillatorAngle0, frequency)
        {
